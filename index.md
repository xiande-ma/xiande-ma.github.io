...
<div style="width: 100%; border-bottom: 1px solid #eee; padding-bottom: 20px; margin-bottom: 40px;">
  <div style="display: flex; justify-content: space-between; align-items: flex-end;">
    <div style="font-size: 1.8em; font-weight: bold; color: #222; letter-spacing: 1px;">
      马先德 (Xiande Ma)
    </div>
...
<div align="center" style="margin: 40px 0;">
  <img src="child.jpg" width="300" style="border-radius: 12px; box-shadow: 0 10px 25px rgba(0,0,0,0.1); border: 1px solid #f0f0f0;">
  <p style="color: #999; font-style: italic; margin-top: 15px; font-size: 0.9em;">
